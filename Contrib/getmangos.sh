...
server/linux/getmangos.sh
@SpaceNinjaApe
SpaceNinjaApe Fix missing bzip2 dependency for CentOS (#187)
Latest commit 21c8913 27 days ago
History
10 contributors
@billy1arm
@Warkdev
...
@skout23
@Cylae
executable file 1640 lines (1407 sloc) 49.2 KB
#!/bin/bash
###############################################################################
